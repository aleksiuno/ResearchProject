...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    if (isset($_POST['register'])) { //user registering
      if($_POST['password']==$_POST['passwordconfirm']){//check if passwords match
        require 'signuplogics.php';
        $show_alert = true;
...
<body>
    <section id="hero">
        ...
        <div class="jumbotron" style="background-color:rgb(244,238,238);">
            <h1 class="text-center" style="font-size:30px;margin:0px 0px 20px;"><strong>SIGN UP</strong><br></h1>
            ...
            <form method="post">
                ...
                <p class="text-center" style="margin:16px 0px 0px;"><label class="d-block" style="margin:auto;">Confirm Your Password</label></p>
                <div class="d-flex" style="margin:auto;"><input class="form-control d-block" type="password" required="" placeholder="Confirm Password" style="margin:auto;width:250px;" name='passwordconfirm'></div>
                <div class="d-block" style="margin:auto;width:200px;">
                    <p class="text-center" style="margin:0;"><button class="btn btn-primary" type="submit" style="margin:30px;" name="register">SIGN UP</button></p>
                </div>
            </form>
        </div>
